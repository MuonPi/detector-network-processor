...
auto simple_coincidence::apply(const event_t& first, const event_t& second) const -> double
{
...
auto simple_coincidence::compare(std::int_fast64_t t1, std::int_fast64_t t2) const -> double
{
